 ...
 * href="http://support.hdfgroup.org/HDF5/">http://support.hdfgroup.org/HDF5/</a>
 * <hr>
 * <p>
 ...
 *          <a href="http://support.hdfgroup.org/HDF5/"> http://support.hdfgroup.org/HDF5"</a>
 **/
public class H5 implements java.io.Serializable {
     ...
     */
    public final static int LIB_VERSION[] = { 1, 8, 19 };
    ...
    /**
     * Get the open ID at the specified index. Always returns -1. To iterate over the set of open IDs, use the
     * getOpenIDs method and use an iterator.
     *
     * @param index
     ...
     *
     * @see public static int H5Acreate( int loc_id, String attr_name, int type_id, int space_id, int acpl_id, int
     *      aapl_id )
     **/
    ...
    private synchronized static native int _H5Acreate_by_name(int loc_id, String obj_name, String attr_name,
            int type_id, int space_id, int acpl_id, int aapl_id, int lapl_id) throws HDF5LibraryException,
     ...
     *                - name is null.
     **/
    public synchronized static native int H5Adelete(int loc_id, String name) throws HDF5LibraryException,
            NullPointerException;
     ...
     *                - attr_name is null.
     **/
    public synchronized static native boolean H5Aexists(int obj_id, String attr_name) throws HDF5LibraryException,
            NullPointerException;
     ...
     *                - Name is null.
     **/
    public static int H5Aopen(int obj_id, String attr_name, int aapl_id) throws HDF5LibraryException,
            NullPointerException {
    ...
    private synchronized static native int _H5Aopen_by_idx(int loc_id, String obj_name, int idx_type, int order,
            long n, int aapl_id, int lapl_id) throws HDF5LibraryException, NullPointerException;
    ...
    /**
     * H5Aopen_idx opens an attribute which is attached to the object specified with loc_id. The location object may be
     * either a group, dataset, or named datatype, all of which may have any sort of attribute.
     *
    ...
    /**
     * H5Aopen_name opens an attribute specified by its name, name, which is attached to the object specified with
     * loc_id.
     *
    ...
    private synchronized static native int _H5Aopen_name(int loc_id, String name) throws HDF5LibraryException,
            NullPointerException;
     ...
     **/
    public synchronized static int H5Aread(int attr_id, int mem_type_id, Object obj) throws HDF5Exception,
            NullPointerException {
    ...
    public synchronized static native int H5AreadComplex(int attr_id, int mem_type_id, String[] buf)
            throws HDF5LibraryException, NullPointerException;
     ...
     **/
    public synchronized static int H5Awrite(int attr_id, int mem_type_id, Object obj) throws HDF5Exception,
            NullPointerException {
        HDFArray theArray = new HDFArray(obj);
    ...
    public static int H5Aget_create_plist(int attr_id) throws HDF5LibraryException {
        int id = _H5Aget_create_plist(attr_id);
        if (id > 0) {
    ...
    private synchronized static native int _H5Aget_create_plist(int attr_id) throws HDF5LibraryException;
     ...
     *                - buf is null.
     **/
     public synchronized static native int H5Aiterate(int loc_id, int idx_type, int order, long idx,
     ...
     *                - buf is null.
     **/
     public synchronized static native int H5Aiterate_by_name(int loc_id, String obj_name, int idx_type,
                        int order, long idx, H5A_iterate_cb op, H5A_iterate_t op_data, int lapl_id) throws HDF5LibraryException, NullPointerException;
     ...
     **/
    @Deprecated
    public synchronized static native int H5Dextend(int dataset_id, byte[] size) throws HDF5LibraryException,
            NullPointerException;
     ...
     *                - buf is null.
     **/
    public synchronized static native void H5Dfill(byte[] fill, int fill_type, byte[] buf, int buf_type, int space_id)
            throws HDF5LibraryException, NullPointerException;
    ...
    private synchronized static native int _H5Dget_space_status(int dset_id, int[] status) throws HDF5LibraryException,
            NullPointerException;
     ...
     *                - Error from the HDF-5 Library.
     **/
    public synchronized static native long H5Dget_storage_size(int dataset_id) throws HDF5LibraryException,
     ...
     *                - buf is null.
     **/
    public synchronized static native int H5Diterate(byte[] buf, int buf_type, int space_id, H5D_iterate_cb op,
    ...
    private synchronized static native int _H5Dopen(int loc_id, String name) throws HDF5LibraryException,
            NullPointerException;
     ...
     **/
    private synchronized static native int _H5Dopen2(int loc_id, String name, int dapl_id) throws HDF5LibraryException,
            NullPointerException;
    ...
    public synchronized static native int H5Dread(int dataset_id, int mem_type_id, int mem_space_id, int file_space_id,
            int xfer_plist_id, byte[] obj, boolean isCriticalPinning) throws HDF5LibraryException, NullPointerException;
     ...
     **/
    public synchronized static int H5Dread(int dataset_id, int mem_type_id, int mem_space_id, int file_space_id,
            int xfer_plist_id, Object obj, boolean isCriticalPinning) throws HDF5Exception, HDF5LibraryException,
            NullPointerException {
        int status = -1;
        boolean is1D = false;
    ...
    public synchronized static native int H5Dread_double(int dataset_id, int mem_type_id, int mem_space_id,
            int file_space_id, int xfer_plist_id, double[] buf, boolean isCriticalPinning) throws HDF5LibraryException,
            NullPointerException;
    ...
    public synchronized static native int H5Dread_float(int dataset_id, int mem_type_id, int mem_space_id,
            int file_space_id, int xfer_plist_id, float[] buf, boolean isCriticalPinning) throws HDF5LibraryException,
            NullPointerException;
    ...
    public synchronized static native int H5Dread_int(int dataset_id, int mem_type_id, int mem_space_id,
            int file_space_id, int xfer_plist_id, int[] buf, boolean isCriticalPinning) throws HDF5LibraryException,
            NullPointerException;
    ...
    public synchronized static native int H5Dread_long(int dataset_id, int mem_type_id, int mem_space_id,
            int file_space_id, int xfer_plist_id, long[] buf, boolean isCriticalPinning) throws HDF5LibraryException,
            NullPointerException;
    ...
    public synchronized static native int H5Dread_short(int dataset_id, int mem_type_id, int mem_space_id,
            int file_space_id, int xfer_plist_id, short[] buf, boolean isCriticalPinning) throws HDF5LibraryException,
            NullPointerException;
     ...
     *                - size is null.
     **/
    public synchronized static native void H5Dset_extent(int dset_id, long size[]) throws HDF5LibraryException,
            NullPointerException;
     ...
     *                - name is null.
     **/
    public synchronized static native int H5Dwrite(int dataset_id, int mem_type_id, int mem_space_id,
            int file_space_id, int xfer_plist_id, byte[] buf, boolean isCriticalPinning) throws HDF5LibraryException,
            NullPointerException;
    ...
    public synchronized static int H5Dwrite_double(int dataset_id, int mem_type_id, int mem_space_id,
            int file_space_id, int xfer_plist_id, double[] buf) throws HDF5LibraryException, NullPointerException {
     ...
     *                - Error from the HDF-5 Library.
     **/
    public synchronized static native String H5Eget_class_name(int class_id) throws HDF5LibraryException,
            NullPointerException;
     ...
     *                - file, func, or msg is null.
      **/
    public static void H5Epush(int stack_id, String file, String func, int line,
            int cls_id, int maj_id, int min_id, String msg) throws HDF5LibraryException, NullPointerException
    {
             H5Epush2(stack_id, file, func, line, cls_id, maj_id, min_id, msg);
    }
    public synchronized static native void H5Epush2(int stack_id, String file, String func, int line,
            int cls_id, int maj_id, int min_id, String msg) throws HDF5LibraryException, NullPointerException;
     ...
     *                - func is null.
     **/
    public static void H5Ewalk(int stack_id, int direction, H5E_walk_cb func, H5E_walk_t client_data) throws HDF5LibraryException, NullPointerException
    {
            H5Ewalk2(stack_id, direction, func, client_data);
    }
    public synchronized static native void H5Ewalk2(int stack_id, int direction, H5E_walk_cb func, H5E_walk_t client_data)
            throws HDF5LibraryException, NullPointerException;
    ...
    private synchronized static native int _H5Fopen(String name, int flags, int access_id) throws HDF5LibraryException,
            NullPointerException;
     ...
     *                - name is null.
     **/
    public static int H5Fcreate(String name, int flags, int create_id, int access_id) throws HDF5LibraryException,
            NullPointerException {
     ...
     *                - name is null.
     **/
    public synchronized static native int H5Funmount(int loc_id, String name) throws HDF5LibraryException,
            NullPointerException;
     ...
     *
     * @return A buffer(H5F_info_t) for current "global" information about file
     *
     * @exception HDF5LibraryException - Error from the HDF-5 Library.
     **/
    public synchronized static native H5F_info_t H5Fget_info(int obj_id) throws HDF5LibraryException;
     ...
     *                - Error from the HDF-5 Library.
     **/
    public synchronized static native void H5Fclear_elink_file_cache(int file_id) throws HDF5LibraryException;
     ...
     * @param size_hint
     *            An optional parameter indicating the number of bytes to reserve for the names that will appear in the
     *            group.
     *
     ...
     **/
    @Deprecated
    public static int H5Gcreate(int loc_id, String name, long size_hint) throws HDF5LibraryException,
            NullPointerException {
    ...
    /**
     * H5Gset_comment sets the comment for the the object name to comment. Any previously existing comment is
     * overwritten.
     *
     * @param loc_id
     *            IN: Identifier of the file, group, dataset, or datatype.
    ...
    /**
     * H5Gget_linkval returns size characters of the link value through the value argument if loc_id (a file or group
     ...
     */
    @Deprecated
    public synchronized static native int H5Gget_num_objs(int loc_id, long[] num_obj) throws HDF5LibraryException,
            NullPointerException;
     ...
     *
     * @return a non-negative value if successful, with the fields of link_info and mtime (if non-null) initialized.
     *
     * @exception HDF5LibraryException
     *                - Error from the HDF-5 Library.
     * @exception NullPointerException
    ...
    public synchronized static native int H5Gget_objinfo(int loc_id, String name, boolean follow_link, long[] fileno,
            long[] objno, int[] link_info, long[] mtime) throws HDF5LibraryException, NullPointerException,
            IllegalArgumentException;
     ...
     *
     * @return a non-negative value if successful, with the fields of HDF5GroupInfo object (if non-null) initialized.
     *
     * @exception HDF5LibraryException
     *                - Error from the HDF-5 Library.
     * @exception NullPointerException
     *                - name is null.
     *
     * @see hdf.hdf5lib.HDF5GroupInfo See public synchronized static native int H5Gget_objinfo();
     *
     ...
     *            Name length
     *
     * @return the size of the object name if successful, or 0 if no name is associated with the group identifier.
     ...
     */
    @Deprecated
    public synchronized static native int H5Gget_objtype_by_idx(int group_id, long idx) throws HDF5LibraryException;
     ...
     *            </UL>
     * @param current_name
     *            A name of the existing object if link is a hard link. Can be anything for the soft link.
     * @param new_name
     ...
     *                - current_name or name is null.
     *
     * @deprecated As of HDF5 1.8, replaced by {@link #H5Lcreate_hard(int, String, int, String, int, int) and
     ...
     **/
    @Deprecated
    public synchronized static native int H5Gunlink(int loc_id, String name) throws HDF5LibraryException,
            NullPointerException;

    /**
     * H5Gmove renames an object within an HDF5 file. The original name, src, is unlinked from the group graph and the
     * new name, dst, is inserted as an atomic operation. Both names are interpreted relative to loc_id, which is either
     * a file or a group identifier.
     *
     * @param loc_id
     ...
     **/
    @Deprecated
    public synchronized static native int H5Gmove(int loc_id, String src, String dst) throws HDF5LibraryException,
            NullPointerException;
     ...
     *                - name is null.
     */
    public synchronized static long H5Gn_members_long(int loc_id, String name) throws HDF5LibraryException,
            NullPointerException {
        int grp_id = H5Gopen(loc_id, name);
        long n = -1;
     ...
     *                - name is null.
     */
    public synchronized static int H5Gn_members(int loc_id, String name) throws HDF5LibraryException,
            NullPointerException {
    ...
    private synchronized static native int _H5Gopen(int loc_id, String name) throws HDF5LibraryException,
            NullPointerException;
    ...
    private synchronized static native int _H5Gopen2(int loc_id, String name, int gapl_id) throws HDF5LibraryException,
            NullPointerException;
    ...
    @Deprecated
    public synchronized static native long H5Iget_name_long(int obj_id, String[] name, long size)
            throws HDF5LibraryException, NullPointerException;
    /**
     ...
     *                - Error from the HDF-5 Library.
     **/
    public synchronized static native int H5Iget_type_ref(int type_id) throws HDF5LibraryException;
     ...
     *                - Error from the HDF-5 Library.
     **/
    public synchronized static native int H5Idec_type_ref(int type_id) throws HDF5LibraryException;
     ...
     *                - Error from the HDF-5 Library.
     **/
    public synchronized static native int H5Iinc_type_ref(int type_id) throws HDF5LibraryException;
     ...
     *                - Error from the HDF-5 Library.
     **/
    public synchronized static native int H5Inmembers(int type_id) throws HDF5LibraryException;
     ...
     *                - Error from the HDF-5 Library.
     **/
    public synchronized static native boolean H5Iis_valid(int obj_id) throws HDF5LibraryException;
     ...
     *                - name is null.
     **/
    public synchronized static native void H5Ldelete(int loc_id, String name, int lapl_id) throws HDF5LibraryException,
            NullPointerException;
    ...
    /**
     * H5Lget_val returns the link value of a symbolic link. Note that this function is a combination
    ...
    public synchronized static native int H5Literate_by_name(int grp_id, String group_name, int idx_type, int order,
            long idx, H5L_iterate_cb op, H5L_iterate_t op_data, int lapl_id) throws HDF5LibraryException,
            NullPointerException;
     ...
     *                - name is null.
     **/
    public synchronized static native H5O_info_t H5Oget_info(int loc_id) throws HDF5LibraryException,
            NullPointerException;
     ...
     *                - name is null.
     **/
    public synchronized static native void H5Olink(int obj_id, int new_loc_id, String new_name, int lcpl_id, int lapl_id)
            throws HDF5LibraryException, NullPointerException;
    ...
    private synchronized static native int _H5Oopen(int loc_id, String name, int lapl_id) throws HDF5LibraryException,
            NullPointerException;
     ...
     *                - name is null.
     **/
    public synchronized static native boolean H5Oexists_by_name(int loc_id, String obj_name, int lapl_id) throws HDF5LibraryException, NullPointerException;
     ...
     * @exception HDF5LibraryException - Error from the HDF-5 Library.
     **/
    public synchronized static native void H5Odecr_refcount(int object_id) throws HDF5LibraryException;
     ...
     * @exception HDF5LibraryException - Error from the HDF-5 Library.
     **/
     public synchronized static native void H5Oincr_refcount(int object_id) throws HDF5LibraryException;
    ...
    public static int H5Oopen_by_addr(int loc_id, long addr) throws HDF5LibraryException {
        int id = _H5Oopen_by_addr(loc_id, addr);
        if (id > 0) {
    ...
    private synchronized static native int _H5Oopen_by_addr(int loc_id, long addr)
            throws HDF5LibraryException, NullPointerException;
     ...
     **/
    public static int H5Oopen_by_idx(int loc_id, String group_name,
            int idx_type, int order, long n, int lapl_id) throws HDF5LibraryException, NullPointerException {
        int id = _H5Oopen_by_idx(loc_id, group_name, idx_type, order, n, lapl_id);
        if (id > 0) {
    ...
    public synchronized static native int _H5Oopen_by_idx(int loc_id, String group_name,
            int idx_type, int order, long n, int lapl_id) throws HDF5LibraryException, NullPointerException;
    ...
    public synchronized static native int _H5Pclose_class(int plid) throws HDF5LibraryException;
    ...
    public static int H5Pcreate_class_nocb(int parent_class, String name) throws HDF5LibraryException {
        int id = _H5Pcreate_class_nocb(parent_class, name);
          if (id > 0) {
    ...
    private synchronized static native int _H5Pcreate_class_nocb(int parent_class, String name) throws HDF5LibraryException;

//    public static int H5Pcreate_class(int parent_class, String name, H5P_cls_create_func_cb create_op, H5P_cls_create_func_t create_data,
...
//        int id = _H5Pcreate_class(parent_class, name, create_op, create_data, copy_op, copy_data, close_op, close_data);
//          if (id > 0) {
...
//    }
//
//    private synchronized static native int _H5Pcreate_class(int parent_class, String name, H5P_cls_create_func_cb create_op, H5P_cls_create_func_t create_data,
//            H5P_cls_copy_func_cb copy_op, H5P_cls_copy_func_t copy_data, H5P_cls_close_func_cb close_op, H5P_cls_close_func_t close_data) throws HDF5LibraryException;

    public synchronized static native void H5Pregister2_nocb(int plist_class, String name, long size, byte[] def_value) throws HDF5LibraryException;

//    public synchronized static native void H5Pregister2(int plist_class, String name, long size, byte[] def_value, H5P_prp_create_func_cb prp_create, H5P_prp_set_func_cb prp_set,
//          H5P_prp_get_func_cb prp_get, H5P_prp_delete_func_cb prp_delete, H5P_prp_copy_func_cb prp_copy, H5P_prp_compare_func_cb prp_cmp, H5P_prp_close_func_cb prp_close) throws HDF5LibraryException;
     ...
     public synchronized static native void H5Pinsert2_nocb(int plist, String name, long size,  byte[] value) throws HDF5LibraryException;


    // public synchronized static native void H5Pinsert2(int plist, String name, long size,  byte[] value, H5P_prp_set_func_cb prp_set, H5P_prp_get_func_cb prp_get,
    ...
    public synchronized static native int H5Piterate(int plist, int[] idx, H5P_iterate_cb op, H5P_iterate_t op_data) throws HDF5LibraryException;
     ...
     *
     **/
    public synchronized static native void H5Pset_attr_phase_change(int ocpl_id, int max_compact, int min_dense)
            throws HDF5LibraryException;
    ...
    public synchronized static native int H5Pget_filter(int plist, int filter_number, int[] flags, int[] cd_nelmts,
            int[] cd_values, int namelen, String[] name) throws ArrayIndexOutOfBoundsException, ArrayStoreException,
    ...
    public synchronized static native int H5Pget_filter_by_id(int plist_id, int filter_id, int[] flags,
            long[] cd_nelmts, int[] cd_values, long namelen, String[] name) throws HDF5LibraryException,
            NullPointerException;
    ...
    public synchronized static native boolean H5Pall_filters_avail(int dcpl_id) throws HDF5LibraryException,
            NullPointerException;
     ...
     *                - size is null.
     **/
    public synchronized static native int H5Pget_userblock(int plist, long[] size) throws HDF5LibraryException,
            NullPointerException;
     ...
     *                - size is invalid.
     **/
    public synchronized static native int H5Pget_sizes(int plist, long[] size) throws HDF5LibraryException,
     ...
     *                - size is invalid.
     **/
    public synchronized static native int H5Pget_sym_k(int plist, int[] size) throws HDF5LibraryException,
            NullPointerException, IllegalArgumentException;
     ...
     *                - ik array is null.
     **/
    public synchronized static native int H5Pget_istore_k(int plist, int[] ik) throws HDF5LibraryException,
            NullPointerException;
     ...
     **/
    public synchronized static native int H5Pget_alignment(int plist, long[] alignment) throws HDF5LibraryException,
            NullPointerException, IllegalArgumentException;
    ...
    public synchronized static native int H5Pset_family_offset(int fapl_id, long offset) throws HDF5LibraryException,
            NullPointerException;
     ...
     *                - an array is null.
     *
     * @deprecated As of HDF5 1.8, replaced by {@link #H5Pget_cache(int, int[], long[], long[], double[]) } because of
     ...
     */
    public synchronized static int H5Pget_gc_reference(int fapl_id, boolean[] gc_ref) throws HDF5LibraryException,
            NullPointerException {
    ...
    public synchronized static native int H5Pget_fclose_degree(int plist_id) throws HDF5LibraryException,
            NullPointerException;

    public synchronized static native int H5Pset_fclose_degree(int plist, int degree) throws HDF5LibraryException,
            NullPointerException;
     ...
     *
     **/
    public synchronized static native int H5Pget_libver_bounds(int fapl_id, int[] libver) throws HDF5LibraryException,
            NullPointerException;
     ...
     *                - dims &lt;=0
     **/
    public synchronized static native int H5Pset_chunk(int plist, int ndims, byte[] dim) throws HDF5LibraryException,
            NullPointerException, IllegalArgumentException;

    public synchronized static int H5Pset_chunk(int plist, int ndims, long[] dim) throws HDF5Exception,
            NullPointerException, IllegalArgumentException {
        if (dim == null) {
            return -1;
        }
     ...
     *
     **/
    public synchronized static native int H5Pget_external(int plist, int idx, long name_size, String[] name, long[] size)
            throws ArrayIndexOutOfBoundsException, ArrayStoreException, HDF5LibraryException, NullPointerException,
            IllegalArgumentException;
    ...
    public synchronized static native int H5Pset_alloc_time(int plist_id, int alloc_time) throws HDF5LibraryException,
            NullPointerException;

    public synchronized static native int H5Pget_fill_time(int plist_id, int[] fill_time) throws HDF5LibraryException,
            NullPointerException;

    public synchronized static native int H5Pset_fill_time(int plist_id, int fill_time) throws HDF5LibraryException,
            NullPointerException;
    ...
    public synchronized static native long H5Pget_buffer_size(int plist) throws HDF5LibraryException,
            IllegalArgumentException;
     ...
     *                - plist is invalid.
     **/
    public synchronized static native void H5Pset_buffer_size(int plist, long size) throws HDF5LibraryException,
            IllegalArgumentException;

    public synchronized static native int H5Pget_edc_check(int plist) throws HDF5LibraryException, NullPointerException;

    public synchronized static native int H5Pset_edc_check(int plist, int check) throws HDF5LibraryException,
            NullPointerException;
     ...
     *
     **/
    public synchronized static native int H5Pset_nlinks(int lapl_id, long nlinks) throws HDF5LibraryException,
            IllegalArgumentException;
     ...
     *
     **/
    public synchronized static native int H5Pset_elink_prefix(int lapl_id, String prefix) throws HDF5LibraryException,
            NullPointerException;
     ...
     *
     **/
    public synchronized static native int H5Pset_elink_acc_flags(int lapl_id, int flags) throws HDF5LibraryException,
            IllegalArgumentException;
     ...
     **/
    public synchronized static native int H5Pget_version(int plist, int[] version_info) throws HDF5LibraryException,
            NullPointerException, IllegalArgumentException;
     ...
     **/
    @Deprecated
    public synchronized static native int H5Pset_preserve(int plist, boolean status) throws HDF5LibraryException,
            IllegalArgumentException;
    ...
    public synchronized static native int H5Pset_fapl_sec2(int fapl_id) throws HDF5LibraryException,
            NullPointerException;
    ...
    public synchronized static native int H5Pset_fapl_stdio(int fapl_id) throws HDF5LibraryException,
            NullPointerException;

    public synchronized static native int H5Pset_fapl_windows(int fapl_id) throws HDF5LibraryException,
            NullPointerException;
     ...
     **/
    public static int H5Rdereference(int dataset, int ref_type, byte[] ref) throws HDF5LibraryException,
            NullPointerException, IllegalArgumentException {
    ...
    /*
     * [NOTE: This function is only supported in HDF5 Releases 1.4.x. It has been replaced in Release 1.6 by the
     * function H5Rget_obj_type public synchronized static native int H5Rget_object_type(int loc_id, byte ref[]) throws
     ...
     *
     * @return Returns the object type, which is the same as obj_type[0]. The return value is the same as the HDF5 1.6
     *         version.
     *
     * @exception HDF5LibraryException
     *                - Error from the HDF-5 Library.
     ...
     *                - output array is invalid.
     **/
    public static int H5Rget_region(int loc_id, int ref_type, byte[] ref) throws HDF5LibraryException,
            NullPointerException, IllegalArgumentException {
     ...
     **/
    public static int H5Screate_simple(int rank, long[] dims, long[] maxdims) throws HDF5Exception,
            NullPointerException {
     ...
     **/
    @Deprecated
    public static int H5Screate_simple(int rank, byte[] dims, byte[] maxdims) throws HDF5Exception,
            NullPointerException {
     ...
     **/
    public synchronized static native int H5Soffset_simple(int space_id, byte[] offset) throws HDF5LibraryException,
            NullPointerException;

    public synchronized static int H5Soffset_simple(int space_id, long[] offset) throws HDF5Exception,
            NullPointerException {
        if (offset == null) {
            return -1;
        }
    ...
    public synchronized static int H5Sset_extent_simple(int space_id, int rank, byte[] current_size, byte[] maximum_size)
            throws HDF5LibraryException, NullPointerException {
     ...
     **/
    @Deprecated
    public static int H5Tarray_create(int base, int rank, int[] dims, int[] perms) throws HDF5LibraryException,
            NullPointerException {
     ...
     *                - dim is null.
     **/
    public static int H5Tarray_create(int base_id, int ndims, long[] dim) throws HDF5LibraryException,
            NullPointerException {
     ...
     **/
    @Deprecated
    public static int H5Tcommit(int loc_id, String name, int type_id) throws HDF5LibraryException, NullPointerException {
        return H5Tcommit1(loc_id, name, type_id);
    }

    @Deprecated
    public synchronized static native int H5Tcommit1(int loc_id, String name, int type) throws HDF5LibraryException,
            NullPointerException;
     ...
     *                - buf is null.
     **/
    public static int H5Tdecode(byte[] buf) throws HDF5LibraryException, NullPointerException {
        int id = _H5Tdecode(buf);
        if (id > 0) {
    ...
    private synchronized static native int _H5Tdecode(byte[] buf) throws HDF5LibraryException, NullPointerException;
     ...
     *                - buf is null.
     **/
    public synchronized static native int H5Tencode(int obj_id, byte[] buf, long nalloc) throws HDF5LibraryException,
            NullPointerException;
     ...
     *                - name is null.
     **/
    public static int H5Tenum_nameof(int type, int[] value, String[] name, int size) throws HDF5LibraryException,
            NullPointerException {
     ...
     *                - name is null.
     **/
    public static int H5Tenum_valueof(int type, String name, int[] value) throws HDF5LibraryException,
            NullPointerException {
     ...
     **/
    @Deprecated
    public static int H5Tget_array_dims(int type_id, long[] dims, int[] perm) throws HDF5LibraryException,
            NullPointerException {
     ...
     **/
    public synchronized static native int H5Tget_array_dims2(int type_id, long[] dims) throws HDF5LibraryException,
            NullPointerException;
    ...
    public static int H5Tget_create_plist(int type_id) throws HDF5LibraryException {
        int id = _H5Tget_create_plist(type_id);
        if (id > 0) {
    ...
    private synchronized static native int _H5Tget_create_plist(int type_id) throws HDF5LibraryException;
     ...
     **/
    public synchronized static native void H5Tget_fields(int type_id, long[] fields) throws HDF5LibraryException,
            NullPointerException, IllegalArgumentException;
     ...
     *                - fields array is invalid.
     **/
    public static int H5Tget_fields(int type_id, int[] fields) throws HDF5LibraryException, NullPointerException,
            IllegalArgumentException {
     ...
     *                - value is null.
     **/
    public static int H5Tget_member_value(int type_id, int membno, int[] value) throws HDF5LibraryException,
            NullPointerException {
     ...
     *                - pad is null.
     **/
    public synchronized static native int H5Tget_pad(int type_id, int[] pad) throws HDF5LibraryException,
            NullPointerException;
    ...
    private synchronized static native int _H5Topen(int loc_id, String name) throws HDF5LibraryException,
            NullPointerException;
    ...
    private synchronized static native int _H5Topen2(int loc_id, String name, int tapl_id) throws HDF5LibraryException,
            NullPointerException;
