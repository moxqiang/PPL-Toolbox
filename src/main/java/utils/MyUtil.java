...
public class MyUtil {
    ...
    public static ComparatorReadATBySE comparatorReadATBySE = new ComparatorReadATBySE();
    ...
    public static void checkFormatAligntable(String file) throws IOException {
        String[] fields = new BufferedReader(new FileReader(file)).readLine().split("\t");
        try {
            ReadAT at = new ReadAT(fields);
        } catch (Exception exception){
            System.out.println("ERROR: inputfile format is not a simple .aligntable file format" +
                    "\nright format:" +
    ...
    public static void runShell(String path) {
        ...
        if (f.exists()) {
            try {
                String reBash = "bash";
                String command = "bash " + path;// notice the blank behind sh
