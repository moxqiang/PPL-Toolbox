...
//        InputStream in = MyError.class.getResourceAsStream("./help.txt");
...
//        System.out.println("    --cutoffMapq\tcutoff of mapping quality score for filtering out low-quality or multiply-mapped reads, default: 20");
//        System.out.println("    --mergeM\tMerge two mappings, when read distance of two mappings < the value, default: 15");
//        System.out.println("    --mergeL\tMerge two mappings, when genome distance of two mappings < the value, default: 30");
//        System.out.println("    --cutoffFrag\tcutoff distance when annotate alignments with fragments, default: 0.5");
...
//        System.out.println("    --splitReads\tOnly for linker mode, N or Y");
//        System.out.println("    --aligner\tbwasw, minimap2 or falign please, default minimap2");
//        System.out.println("    --weightAS\tweight of AS(alignment score) when make alignments selection, default 1");
//        System.out.println("    --alignerPath\tWhen you want to select a aligner in different version, input the path.\n eg. /home/zjwang/minimap2_1.0/minimap2");
//
//
//        System.out.println("################################################################################");
...
//        System.out.println("    --addcluster\tKeep all regions with more than 2 count reads as potential anchor for calling loop. default: N. if peaks number of macs2 smaller than 10000, this paramater will work automaticly.");
    ...
    public static void colNumError(int count) {
        System.out.println("Error: columns num of input is "+count+"!!!");
        System.exit(0);
    }
    public static void unknowSymbolError(String symbol){
        System.out.println("Error: this cigar string include unknow symbol: "+symbol);
        System.exit(0);
    }
    public static void strandError(String symbol){
        System.out.println("Error: strand symbol only can be +/- or *: "+symbol);
        System.exit(0);
    }
}
